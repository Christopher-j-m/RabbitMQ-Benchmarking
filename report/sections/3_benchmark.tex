...
Every experiment begins with a configurable warmup phase during which the cluster reaches a steady state. Measurements taken during warmup are excluded from the recorded results.
